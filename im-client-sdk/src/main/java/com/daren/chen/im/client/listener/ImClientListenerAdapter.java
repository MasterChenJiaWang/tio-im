...
public class ImClientListenerAdapter implements ClientAioListener, ImConst {
     ...
     * 客户端端监听器
     */
    private final ImClientListener imClientListener;
    ...
    public void onAfterSent(ChannelContext channelContext, Packet packet, boolean isSentSuccess) throws Exception {
        imClientListener.onAfterSent((ImClientChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
    ...
    public void onBeforeClose(ChannelContext channelContext, Throwable throwable, String remark, boolean isRemove)
        throws Exception {
        imClientListener.onBeforeClose((ImClientChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
            throwable, remark, isRemove);
    }

    @Override
    public void onAfterDecoded(ChannelContext channelContext, Packet packet, int packetSize) throws Exception {
        imClientListener.onAfterDecoded((ImClientChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
            (ImPacket)packet, packetSize);
    }

    @Override
    public void onAfterReceivedBytes(ChannelContext channelContext, int receivedBytes) throws Exception {
        imClientListener.onAfterReceivedBytes((ImClientChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
            receivedBytes);
    }

    @Override
    public void onAfterHandled(ChannelContext channelContext, Packet packet, long cost) throws Exception {
        imClientListener.onAfterHandled((ImClientChannelContext)channelContext.get(Key.IM_CHANNEL_CONTEXT_KEY),
