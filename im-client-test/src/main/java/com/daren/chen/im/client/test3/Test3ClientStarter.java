...
import com.daren.chen.im.client.test.HelloImClientListener;
 ...
 */
public class Test3ClientStarter {
    private static final Logger logger = LoggerFactory.getLogger(Test3ClientStarter.class);
    ...
    private static void send() throws Exception {
        String userId = "13888800001";
        String token = "13888800001";
        ...
        Thread.sleep(6000);
        //
        sendMessage(userId, "13888800006", "1");
