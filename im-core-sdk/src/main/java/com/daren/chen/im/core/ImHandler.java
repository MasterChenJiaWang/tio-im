...
public interface ImHandler {
     ...
     *            ByteBuffer的limit
     * @param position
     *            ByteBuffer的position，不一定是0哦
     * @param readableLength
     *            ByteBuffer参与本次解码的有效数据（= limit - position）
     * @param imChannelContext
     * @return
     * @throws ImDecodeException
     */
    ImPacket decode(ByteBuffer buffer, int limit, int position, int readableLength, ImChannelContext imChannelContext)
        throws ImDecodeException, ImDecodeException;
