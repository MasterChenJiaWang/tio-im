...
public class CaffeineUtils {
     ...
     * @return
     */
    public static <K, V> LoadingCache<K, V> createLoadingCache(String cacheName, Integer timeToLiveSeconds,
        Integer timeToIdleSeconds, Integer initialCapacity, Integer maximumSize, boolean recordStats) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LoadingCache<String, Object> loadingCache = CaffeineUtils.createLoadingCache("mycache", timeToLiveSeconds,
            timeToIdleSeconds, initialCapacity, maximumSize, recordStats);
