package com.daren.chen.im.core.cache.caffeineredis;
...
import com.daren.chen.im.core.cache.caffeine.CaffeineCache;
import com.daren.chen.im.core.cache.caffeine.CaffeineCacheManager;
import com.daren.chen.im.core.cache.caffeine.CaffeineConfiguration;
import com.daren.chen.im.core.cache.caffeine.CaffeineConfigurationFactory;
import com.daren.chen.im.core.cache.redis.RedisCache;
import com.daren.chen.im.core.cache.redis.RedisCacheManager;
import com.daren.chen.im.core.cache.redis.SubRunnable;
    ...
    static {
        try {
            ...
            for (CaffeineConfiguration configuration : configurations) {
                register(configuration.getCacheName(), configuration.getTimeToLiveSeconds(),
                    configuration.getTimeToIdleSeconds());
            }
        } catch (Exception e) {
        ...
        if (caffeineRedisCache == null) {
            synchronized (CaffeineRedisCacheManager.class) {
                ...
                if (caffeineRedisCache == null) {
                    ...
                    CaffeineCache caffeineCache = CaffeineCacheManager.register(cacheName, timeToLiveSecondsForCaffeine,
