...
public class RedisConfigurationFactory {
    ...
    public static void initRedisConfiguration(RedisConfiguration redisConfiguration) {
        RedisConfigurationFactory.redisConfiguration = redisConfiguration;
    }
    ...
    public static RedisConfiguration parseConfiguration() throws Exception {
        ...
        // } else {
        // LOG.warn("No configuration found. Configuring redis from jim.properties " + " found in the classpath: {}",
        // url);
        //
        // }
