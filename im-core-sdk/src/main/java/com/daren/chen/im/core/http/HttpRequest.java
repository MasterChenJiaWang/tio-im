...
public class HttpRequest extends HttpPacket {
     ...
     * @param args
     *
     * @author wchao 2017年2月22日 下午4:14:40
     *
     */
    ...
    public Boolean getIsAjax() {
        if (isAjax == null) {
            String xRequestedWith = this.getHeader(Http.RequestHeaderKey.X_Requested_With);
    ...
    public Boolean getIsSupportGzip() {
        if (isSupportGzip == null) {
            String acceptEncoding = getHeader(Http.RequestHeaderKey.Accept_Encoding);
            if (StringUtils.isNoneBlank(acceptEncoding)) {
                String[] ss = StringUtils.split(acceptEncoding, ",");
