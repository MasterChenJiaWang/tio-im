...
import com.daren.chen.im.core.utils.HttpParseUtils;
...
public class HttpRequestDecoder implements ImConst {
    ...
    public static HttpRequest decode(ByteBuffer buffer, ImChannelContext channelContext, boolean isBody)
    ...
    public static void decodeParams(Map<String, Object[]> params, String paramsStr, String charset,
        ImChannelContext channelContext) {
    ...
    private static void parseBody(HttpRequest httpRequest, RequestLine firstLine, byte[] bodyBytes,
                                  ImChannelContext channelContext) throws ImDecodeException {
        ...
        if (bodyFormat == Http.RequestBodyFormat.MULTIPART) {
            ...
            String initBoundary = HttpParseUtils.getPerprotyEqualValue(httpRequest.getHeaders(),
                Http.RequestHeaderKey.Content_Type, "boundary");
    ...
    public static void parseBodyFormat(HttpRequest httpRequest, Map<String, String> headers) {
        ...
        if (StringUtils.contains(Content_Type,
            Http.RequestHeaderValue.Content_Type.application_x_www_form_urlencoded)) {
        ...
        if (StringUtils.isNotBlank(Content_Type)) {
            String charset =
                HttpParseUtils.getPerprotyEqualValue(headers, Http.RequestHeaderKey.Content_Type, "charset");
     ...
     * @param line
     * @return
     * @author WChao 2017年2月23日 下午1:37:58
     */
     ...
     * @return
     *
     * @author WChao 2017年2月23日 下午1:37:51
     *
     */
    ...
    private static void parseUrlencoded(HttpRequest httpRequest, RequestLine firstLine, byte[] bodyBytes,
                                        String bodyString, ImChannelContext channelContext) {
     ...
     * @param channelContext
     */
    private static void parseQueryString(HttpRequest httpRequest, RequestLine firstLine,
        ImChannelContext channelContext) {
    ...
    /**
     *
     * @author WChao 2017年2月22日 下午4:06:42
     *
     */
