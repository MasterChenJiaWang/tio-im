package com.daren.chen.im.core.http.listener;
...
/**
 * @author wchao 2017年7月25日 下午2:16:06
 */
public interface IHttpServerListener {

    /**
     * 在执行org.tio.http.server.handler.IHttpRequestHandler.handler(HttpRequestPacket, RequestLine,
     * ChannelContext<HttpSessionContext, HttpPacket, Object>)后会调用此方法，业务层可以统一在这里给HttpResponsePacket作一些修饰
     *
     * @param packet
     * @param requestLine
    ...
    /**
     * 在执行org.tio.http.server.handler.IHttpRequestHandler.handler(HttpRequestPacket, RequestLine,
     * ChannelContext<HttpSessionContext, HttpPacket, Object>)前会先调用这个方法<br>
