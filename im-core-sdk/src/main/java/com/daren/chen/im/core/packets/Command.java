...
import com.daren.chen.im.core.utils.DynamicEnumUtil;
...
public enum Command {
     ...
     * <code>COMMAND_GET_MESSAGE_RESP = 20;</code>
     */
    COMMAND_NOTICE_MESSAGE_RESP(22),
     ...
     * <code>COMMAND_JOIN_GROUP_RESP = 8;</code>
     */
    COMMAND_ADD_FRIEND_REQ_RESP(26),
     ...
     * <code>COMMAND_JOIN_GROUP_RESP = 8;</code>
     */
    COMMAND_DELETE_FRIEND_REQ_RESP(28),
    ...
    // * <code>COMMAND_JOIN_GROUP_RESP = 8;</code>
    // */
    // COMMAND_ADD_GROUP_REQ_RESP(30);

    /**
     * 获取用户的状态请求
     */
    GET_USER_ONLINE_STATUS_REQ(32),
    /**
     * 获取用户的状态响应
     */
    GET_USER_ONLINE_STATUS_REQ_RESP(33),
     ...
     * 消息通知响应
     */
    MSG_NOTICE_REQ_RESP(35),

    /**
     * 下线通知请求
     */
    NOTICE_OFFLINE_REQ(36),

    /**
     * 下线通知响应
     */
    NOTICE_OFFLINE_REQ_RESP(37),

    /**
     * 接收通知请求
     */
    RECEIVE_MSG_NOTICE_REQ(38),
    /**
     * 接收通知响应
     */
    RECEIVE_MSG_NOTICE_REQ_RESP(39),
