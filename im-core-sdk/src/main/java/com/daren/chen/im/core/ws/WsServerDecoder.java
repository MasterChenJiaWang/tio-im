...
import com.daren.chen.im.core.utils.BASE64Util;
import com.daren.chen.im.core.utils.SHA1Util;

/**
 *
 * @author wchao 2017年7月30日 上午10:10:50
 */
public class WsServerDecoder implements ImConst {
    ...
    public static WsRequestPacket decode(ByteBuffer buf, ImChannelContext imChannelContext) throws ImDecodeException {
        ...
        if (!fin) {
            ...
            lastParts.add(array);
            log.warn("payloadLength {}, lastParts size {}, array length {}", payloadLength, lastParts.size(),
                array.length);
            return websocketPacket;
        } else {
