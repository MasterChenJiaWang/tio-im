...
import com.daren.chen.im.core.http.UploadFile;
...
/**
 * @author WChao 2017年6月29日 下午7:53:59
 */
...
public class TestController {
    ...
    String html =
        "<div style='position:relation;border-radius:10px;text-align:center;padding:10px;font-size:40pt;font-weight:bold;background-color:##e4eaf4;color:#2d8cf0;border:0px solid #2d8cf0; width:600px;height:400px;margin:auto;box-shadow: 1px 1px 50px #000;position: fixed;top:0;left:0;right:0;bottom:0;'>"
