 ...
 */
public class MsgAckQueueRunnable extends AbstractQueueRunnable<Message> {

    private final Logger log = LoggerFactory.getLogger(MsgAckQueueRunnable.class);
    ...
    public MsgAckQueueRunnable(ImChannelContext imChannelContext, Executor executor) {
        super(executor);
