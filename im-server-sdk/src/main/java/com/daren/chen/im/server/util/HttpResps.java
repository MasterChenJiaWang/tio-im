...
import com.daren.chen.im.core.http.HttpResponseStatus;
import com.daren.chen.im.core.http.MimeType;

import cn.hutool.core.io.FileUtil;

/**
 * @author WChao 2017年6月29日 下午4:17:24
 */
public class HttpResps implements ImConst.Http {
    private static final Logger log = LoggerFactory.getLogger(HttpResps.class);
    ...
    public static HttpResponse css(HttpRequest request, String bodyString, String charset) {
        HttpResponse ret =
            string(request, bodyString, charset, MimeType.TEXT_CSS_CSS.getType() + "; charset=" + charset);
        return ret;
    }
     ...
     * @author WChao
     */
    public static HttpResponse fileWithHeaders(HttpRequest request, byte[] bodyBytes, Map<String, String> headers,
    ...
    public static HttpResponse html(HttpRequest request, String bodyString, String charset) {
        HttpResponse ret =
            string(request, bodyString, charset, MimeType.TEXT_HTML_HTML.getType() + "; charset=" + charset);
        return ret;
    }
    ...
    public static HttpResponse js(HttpRequest request, String bodyString, String charset) {
        HttpResponse ret =
            string(request, bodyString, charset, MimeType.APPLICATION_JAVASCRIPT_JS.getType() + "; charset=" + charset);
        return ret;
    }
    ...
    public static HttpResponse json(HttpRequest request, Object body, String charset) {
        ...
        if (body == null) {
            ...
            if (body.getClass() == String.class) {
                ret =
                    string(request, (String)body, charset, MimeType.TEXT_PLAIN_JSON.getType() + "; charset=" + charset);
            } else {
                ret = string(request, Json.toJson(body), charset,
                    MimeType.TEXT_PLAIN_JSON.getType() + "; charset=" + charset);
            }
        }
    ...
    public static HttpResponse try304(HttpRequest request, long lastModifiedOnServer) {
        ...
        if (StringUtils.isNoneBlank(If_Modified_Since)) {
            ...
            try {
                ...
                log.warn("{}, {}不是整数，浏览器信息:{}", request.getRemote(), If_Modified_Since,
                    request.getHeader(RequestHeaderKey.User_Agent));
                return null;
            }
        }
    ...
    public static HttpResponse txt(HttpRequest request, String bodyString, String charset) {
        HttpResponse ret =
            string(request, bodyString, charset, MimeType.TEXT_PLAIN_TXT.getType() + "; charset=" + charset);
        return ret;
    }
