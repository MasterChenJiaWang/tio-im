...
public class RedisTest {
    ...
    public void keys() throws Exception {
        Set<String> test1 = JedisTemplate.me().keys("group");
    ...
    public void delKeysLike() throws Exception {
        long group1 = JedisTemplate.me().delKeysLike("lastId:group");
    ...
    public void delKey() throws Exception {
        long group1 = JedisTemplate.me().delKey("userToken:13888800001");
        System.out.println(group1);
    ...
    public void delKeys() throws Exception {
        long group1 = JedisTemplate.me().delKeys(new String[] {"user:13888800001:info", "user:13888800002:info"});
        System.out.println(group1);
    ...
    public void expire() throws Exception {
        long group1 = JedisTemplate.me().expire("user:13888800001:group", 111);
        System.out.println(group1);
    ...
    public void makeId() throws Exception {
        long group1 = JedisTemplate.me().makeId("makeId:test1");
        System.out.println(group1);
    ...
    public void decr() throws Exception {
        long group1 = 0;
        try {
            group1 = JedisTemplate.me().decr("makeId:test2", 5);
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.out.println(group1);
    ...
    public void incr() throws Exception {
        ...
        long group1 = 0;
        try {
            group1 = JedisTemplate.me().incr("makeId:test4", 5);
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.out.println(group1);
    ...
    public void setString() throws Exception {
        String test1 = JedisTemplate.me().setString("setString:test1", "test1");
    ...
    public void setString2Boolean() throws Exception {
        boolean test1 = JedisTemplate.me().setString2Boolean("setString:test3", "test4", 100);
        System.out.println(test1);
    ...
    public void setString2() throws Exception {
        String test1 = JedisTemplate.me().setString("setString:test5", "test5", 100);
        System.out.println(test1);
    ...
    public void setStringIfNotExists() throws Exception {
        Long test1 = JedisTemplate.me().setStringIfNotExists("setString:test5", "test5");
        System.out.println(test1);
        Long test2 = RedissonTemplate.me().setStringIfNotExists("setString:test6", "test6");
        System.out.println(test2);
        System.out.println("......");

        Long test3 = JedisTemplate.me().setStringIfNotExists("setString:test7", "test7");
    ...
    public void getString() throws Exception {
        String test1 = JedisTemplate.me().getString("setString:test1");
        System.out.println(test1);
    ...
    public void batchSetString() throws Exception {
        ...
        List<Object> list = JedisTemplate.me().batchSetString(pairs);
    ...
    public void hashSet() throws Exception {
        Long test1 = JedisTemplate.me().hashSet("hashSet5", "test2", "2");
        System.out.println(test1);
    ...
    public void hashGet() throws Exception {
        Long test1 = JedisTemplate.me().hashSet("hashSet5", "test3", "3");
        System.out.println(test1);
    ...
    public void hashMultipleSet() throws Exception {
        ...
        hash.put("test1", "1");
        hash.put("test2", "2");
        String test1 = JedisTemplate.me().hashMultipleSet("hashSet6", hash);
        String test2 = JedisTemplate.me().hashMultipleSet("hashSet7", hash, 100);
        System.out.println(test1);
        System.out.println(test2);
        ...
        List<String> list = JedisTemplate.me().hashMultipleGet("hashSet7", "test1", "test2");
        for (String s1 : list) {
            System.out.println(s1);
        }
        System.out.println("<><><><>");
        List<String> list2 = JedisTemplate.me().hashMultipleGet("hashSet6", 1000, "test1", "test2");
        for (String s1 : list2) {
            System.out.println(s1);
        }
        System.out.println("<><><><>");
    ...
    public void hashGetAll() throws Exception {
        Map<String, String> hashSet8 = JedisTemplate.me().hashGetAll("hashSet8");
    ...
    public void hashDel() throws Exception {
        JedisTemplate.me().hashDel("hashSet8", new String[] {"test1"});
        System.out.println("...............");
    ...
    public void listPushTail() throws Exception {
        // for (int i = 1; i < 4; i++) {
        // Long test1 = JedisTemplate.me().listPushTail("listPushTail" + i, "test1", "test2");
        // System.out.println(test1);
        // Long test2 = RedissonTemplate.me().listPushTail("listPushTail" + i, "test3", "test4");
        // System.out.println(test2);
        // Long test12 = JedisTemplate.me().listPushTail("listPushTail" + i, "test1", "test2");
        ...
        for (int i = 0; i < 10000; i++) {
            // Long test1 = JedisTemplate.me().listPushTail("listPushTail1", "test1", "test2");
            // System.out.println(test1);
    ...
    public void listPushHead() throws Exception {
        Long test1 = JedisTemplate.me().listPushHead("listPushTail1", "test1-new1");
        System.out.println(test1);
    ...
    public void listRemove() throws Exception {
        Long test1 = JedisTemplate.me().listRemove("listPushTail1", 0, "test1");
        System.out.println(test1);
        Long test2 = RedissonTemplate.me().listRemove("listPushTail1", 0, "test2");
        System.out.println(test2);
        Long test3 = JedisTemplate.me().listRemove("listPushTail2", 1, "test1");
        System.out.println(test3);
        Long test4 = RedissonTemplate.me().listRemove("listPushTail2", 1, "test2");
        System.out.println(test4);

        Long test5 = JedisTemplate.me().listRemove("listPushTail3", 1, "test1");
    ...
    public void listPushHeadAndTrim() throws Exception {
        Long test1 = JedisTemplate.me().listPushHeadAndTrim("listPushTail2", "test1-new1", 3);
        System.out.println(test1);
    ...
    public void batchListPushTail() throws Exception {
        new Thread(() -> {
            try {
                JedisTemplate.me().batchListPushTail("listPushTail3", new String[] {"test1", "test2", "test3"}, true);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }).start();
    ...
    public void updateListInTransaction() throws Exception {
        ...
        list1.add("test2");
        list1.add("test3");
        JedisTemplate.me().updateListInTransaction("listPushTail2", list1);
    ...
    public void insertListIfNotExists() throws Exception {
        new Thread(() -> {
            try {
                JedisTemplate.me().insertListIfNotExists("listPushTail5", new String[] {"test1", "test2", "test3"});
            } catch (Exception e) {
                e.printStackTrace();
            }
        }).start();
    ...
    public void listGetAll() throws Exception {
        List<String> list1 = JedisTemplate.me().listGetAll("listPushTail2");
        for (String s : list1) {
            System.out.println(s);
        }
        System.out.println(".....");
    ...
    public void listRange() throws Exception {
        List<String> list1 = JedisTemplate.me().listRange("listPushTail1", 0, 5);
        for (String s : list1) {
            System.out.println(s);
        }
        System.out.println(".....");
    ...
    public void sortSetPush() throws Exception {
        Long test1 = JedisTemplate.me().sortSetPush("sortSetPush1", 2, "test1");
        System.out.println(test1);
        Long test2 = RedissonTemplate.me().sortSetPush("sortSetPush1", 1, "test2");
        System.out.println(test2);
        JedisTemplate.me().sortRemove("sortSetPush1", "test2");
        JedisTemplate.me().sortRemove("sortSetPush1", "test1");

        for (int i = 1; i <= 10000; i++) {
            JedisTemplate.me().sortSetPush("sortSetPush1", i, "test" + i);
        }
    ...
    public void sorSetRangeByScore() throws Exception {
        Set<String> list1 = JedisTemplate.me().sorSetRangeByScore("sortSetPush1", 1, 5);
        for (String s : list1) {
            System.out.println(s);
        }
        System.out.println(".....");
        ...
        Set<String> list3 = JedisTemplate.me().sorSetRangeByScore("sortSetPush1", 100, 5000, 100, 10);
        for (String s : list3) {
            System.out.println(s);
        }
        System.out.println(".....");
    ...
    public void addWithSortedSet() throws Exception {
        Long test1 = JedisTemplate.me().addWithSortedSet("sortSetPush2", 2, "test1");
        System.out.println(test1);
    ...
    public void revrangeByScoreWithSortedSet() throws Exception {
        Set<String> list1 = JedisTemplate.me().revrangeByScoreWithSortedSet("sortSetPush1", 5, 1);
        for (String s : list1) {
            System.out.println(s);
        }
        System.out.println(".....");
    ...
    public void publish() throws Exception {
        Long test1 = JedisTemplate.me().publish("dev_1111_JIM_CLUSTER", "test1");
        System.out.println(test1);
